#!/bin/bash
# Evaluate HardFlow (l4casadi-free variant) on the 1-D Burgers PDE control task.
...
eval_exp_name="4e5steps_hardflow_new_${ode_t_steps}steps"

echo "=== Running HardFlow (new) on Burgers (n_test_samples=${n_test_samples}) ==="
